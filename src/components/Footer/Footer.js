...
function Footer() {
    return (
        ...
        <div className="copy d-flex">
          <Link className="navbar-brand krida"  to="index.html">KR<span>1</span>DA</Link>
          <p style={{marginBottom: "0", marginRight: "5px"}}>&copy;</p>
          <span> 2021</span>
        </div>
    
        <div className="social">
          <Link to="https://github.com/bhattritik21">
